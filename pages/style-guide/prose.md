...
On many sites, prose (sites, README, docs, etc) is authored with [GitHub Flavored Markdown](http://github.github.com/github-flavored-markdown/).
Some sites (e.g. api.jquery.com) use an XML-based markup system but the advice offered here for good writing still applies.
